...
public class LoadJsonParams : MonoBehaviour
{
    ...
    private class HearingAidParameters
    {
    ...
    private class HearingLossParameters
    {
    ...
    private HearingAidParameters HAParams = new HearingAidParameters();
    private HearingLossParameters HLParams = new HearingLossParameters();
